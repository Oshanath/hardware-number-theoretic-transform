...
module inverse_NTT_mixed_tb;
    ...
    initial begin
        $dumpfile("inverse_NTT_mixed_tb.vcd");
        $dumpvars(0, inverse_NTT_mixed_tb);
        ...
        if (errors == 0) begin
            $display("All inverse NTT mixed tests passed.");
        end else begin
            $display("inverse NTT mixed tests failed with %0d error(s).", errors);
        end
    ...
    task run_inverse8;
        ...
        begin
            ...
            $display("TESTCASE inverse N=8 testcase=%0d setup", testcase);
            ...
            $display("TESTCASE inverse N=8 testcase=%0d output", testcase);
            for (i = 0; i < N8; i = i + 1) begin
                $display("  output t[%0d]=%0d expected[%0d]=%0d", i, t8[i], i, expected8[i]);
                if (t8[i] !== expected8[i][WIDTH8-1:0]) begin
                    errors = errors + 1;
                end
            end
            ...
            if ((t8[0] !== expected8[0][WIDTH8-1:0]) ||
                ...
                $display("FAIL inverse N=8 testcase=%0d modulus=%0d root=%0d n_inverse=%0d", testcase, MODULUS8, ROOT8, N_INV8);
            end else begin
                $display("PASS inverse N=8 testcase=%0d modulus=%0d root=%0d n_inverse=%0d", testcase, MODULUS8, ROOT8, N_INV8);
            end
    ...
    task run_inverse4;
        ...
        begin
            ...
            $display("TESTCASE inverse N=4 testcase=%0d setup", testcase);
            for (i = 0; i < N4; i = i + 1) begin
                $display("  input[%0d]=%0d", i, a4[i]);
            end
            ...
            $display("TESTCASE inverse N=4 testcase=%0d output", testcase);
            for (i = 0; i < N4; i = i + 1) begin
                $display("  output t[%0d]=%0d expected[%0d]=%0d", i, t4[i], i, expected4[i]);
                if (t4[i] !== expected4[i][WIDTH4-1:0]) begin
                    errors = errors + 1;
                end
            end
            ...
            if ((t4[0] !== expected4[0][WIDTH4-1:0]) ||
                ...
                $display("FAIL inverse N=4 testcase=%0d modulus=%0d root=%0d n_inverse=%0d", testcase, MODULUS4, ROOT4, N_INV4);
            end else begin
                $display("PASS inverse N=4 testcase=%0d modulus=%0d root=%0d n_inverse=%0d", testcase, MODULUS4, ROOT4, N_INV4);
            end
